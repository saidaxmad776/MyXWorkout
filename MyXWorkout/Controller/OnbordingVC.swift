...
class OnbordingVC: UIViewController {
    ...
    private func setupViews() {
        ...
        collectionView.register(OnbordingCVC.self, forCellWithReuseIdentifier: idOnboardingCell)
...
extension OnbordingVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: idOnboardingCell, for: indexPath) as! OnbordingCVC
...
extension OnbordingVC: UICollectionViewDelegateFlowLayout {
